...
| `<i>`Bug-1`</i>` | `<i>`DB Posts or Artciles not loading on front page.`</i>` | `<i>`1.1.2.2`</i>` | `<i>`N/A`</i>` |
...
| 1.1.3 | 2024-10-23 | `<ul><li>`Minor view updates.`</li><li>`Fix articles loading bug.`</li><li>`Update README.md`</li></ul>` |
